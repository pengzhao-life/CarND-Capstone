...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        """
        #rospy.loginfo("new image come in")
        # Skip (SKIP_THRESHOLD - 1) images for a small latency
        self.skip_count += 1
        self.skip_count = self.skip_count % SKIP_THRESHOLD
        if self.skip_count != 0:
            #rospy.loginfo('\nSkip Image: %d', self.skip_count)
            return
    ...
    def get_light_state(self, light):
        ...
        rospy.loginfo('\nDetection: %s', traffic_light_color)
        #rospy.loginfo('\nDetection: %d', light_state)
        return light_state
    ...
    def process_traffic_lights(self):
        ...
        stop_line_positions = self.config['stop_line_positions']
            ...
            #rospy.loginfo('waypoints are None')
